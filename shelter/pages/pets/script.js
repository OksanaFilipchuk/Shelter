...
let background = document.querySelector('.burger-background');
...
burgerBtn.addEventListener('click', function(){
    ...
    background.classList.toggle('burger-background_active');
...
window.onclick = function(event){
    if(event.target == background){
        ...
        background.classList.remove('burger-background_active');
        burgerList.classList.remove('burger-list_active');
...
let json = [ {
    ...
    // let petBtn = document.querySelectorAll('.btn-light');
...
//  petBtn.forEach((el) => el.addEventListener('click', popUpShow));
